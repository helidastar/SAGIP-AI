...
Next.js · TypeScript · Supabase (PostgreSQL + PostGIS) · Vision-LLM API · Leaflet · Vercel

## Project Status

Blueprint stage (Draft v1.1). Requirements, architecture, and data design are documented. Implementation will happen on the `development` branch.
